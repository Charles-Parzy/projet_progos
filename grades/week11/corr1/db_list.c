...
{
    //correcteur: utiliser plutot un switch pour tester une enum.
    if(format == STDOUT) {
        ...
        //correcteur: ca serait mieux de stocker la taille pour ne pas la recalculer (ca fait peu de différence ici car la chaine est petite mais c'est mieux).
        ...
        //correcteur: il faut l'allouer dynamiquement puisqu'on la free plus tard.
